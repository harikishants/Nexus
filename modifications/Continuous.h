...
public:
	...
	void setOutputDim(const std::string & x); //added by Hari
...
//	void plot_2D(const std::string & path, const std::string & fileName, const TaylorModelFlowpipes & flowpipes, Computational_Setting & setting) const;
	...
	void print_interval(const TaylorModelFlowpipes & flowpipes, Computational_Setting & setting, int, double &, double &, bool) const;	//Added by Hari
